...
Introduzcamos una base de autofunciones del operador \eqref{eq:operador} $\qty{\eta_i \qty(\tau)}$
...
Con esto, hemos aproximado la amplitud \eqref{eq:Iaprox1} como un producto de integrales gausianas
\begin{equation}
...
Como se discutió en la sección inicial de este capítulo, la tasa de decaimiento del falso vacío $\Gamma$ está relacionada con la probabilidad de que una partícula permanezca en la región del falso vacío del potencial. %como los de las figuras \ref{fig:potencial} y \ref{fig:potencial_numerico}. 
